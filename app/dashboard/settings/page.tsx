                ...
                {profile.subscription_status === "ACTIVE" ? (
                    profile.cancel_at_period_end ? (
                        <div className="space-y-4">
                            <div className="px-4 py-3 rounded-xl bg-amber-50 text-amber-700 text-sm font-bold">
                    ...
                    <div className="space-y-4">
                        <div className="px-4 py-3 rounded-xl bg-slate-100 text-slate-600 text-sm font-bold">
                            {trialDaysLeft > 0
                                ? `Trial — ${trialDaysLeft} day${trialDaysLeft > 1 ? "s" : ""} left`
                                : "No active subscription"}
                        </div>
                        <SubscribeButton>Subscribe — $19/mo</SubscribeButton>
                    </div>
                )}
            </section>
        </div>
