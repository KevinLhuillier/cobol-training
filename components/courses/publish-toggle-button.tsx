...
export function PublishToggleButton({ table, id, isPublished }: PublishToggleButtonProps) {
    ...
    const onClick = async () => {
        try {
            ...
            // Met à jour l'interface (rafraîchit le badge Draft/Published de la page)
            router.refresh();
        } catch (error) {
